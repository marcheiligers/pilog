...
class WeathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post weathers_url, params: { weather: { humidity: @weather.humidity, location: @weather.location, sensor: @weather.sensor, temperature: @weather.temperature } }
    end
  ...
  test "should update weather" do
    patch weather_url(@weather), params: { weather: { humidity: @weather.humidity, location: @weather.location, sensor: @weather.sensor, temperature: @weather.temperature } }
